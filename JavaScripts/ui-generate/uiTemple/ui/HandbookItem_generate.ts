 ...
 @UIBind('UI/uiTemple/ui/HandbookItem.ui')
 export default class HandbookItem_Generate extends mw.UIScript {
     @UIWidgetBind('MWCanvas_2147482460/MWCanvas_1/mImgIcon')
    public mImgIcon: mw.Image=undefined;
    @UIWidgetBind('MWCanvas_2147482460/MWCanvas_1/mTxtName')
